...
;!function(){
  ...
  */
  ...
  Class.prototype.config = {
    ...
    ,theme: 'default' //主题
    ,position: null //控件定位方式定位, 默认absolute，支持：fixed/absolute/res
  ...
  Class.prototype.checkDate = function(fn){
    ...
    ,value = that.isInput(elem) ? elem.value : (options.position === 'res' ? '' : elem.innerHTML)
  ...
  Class.prototype.setValue = function(value){
    ...
    options.position === 'res' || lay(elem)[valType](value || '');
    return this;
  };
  ...
  Class.prototype.choose = function(td){
    ...
    } else if(options.position === 'res'){ //直接嵌套的选中
      setDateTime(true);
